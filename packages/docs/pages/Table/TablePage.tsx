import { H1, H3, PillTabsProps, Small, Table, TableFigure, TableItem, Text, Panel } from '@bigcommerce/big-design';
...
const TablePage = () => {
  return (
    <>
      ...
      <Panel header="Table props">
        <TablePropTable renderAsContent />
        <TableColumnsPropTable id="table-columns-prop-table" renderAsContent />
        <TableSelectablePropTable id="table-selectable-prop-table" renderAsContent />
        <TableSortablePropTable id="table-sortable-prop-table" renderAsContent />
        <TableSearchPropTable id="table-search-prop-table" renderAsContent />
      </Panel>

      <Panel header="Examples">
        <H3>Usage with selectable</H3>
        ...
        <H3>Usage with TableFigure</H3>

        <Text>
          <Code primary>TableFigure</Code> components are used to wrap tables and any relevant information to be grouped
          with them.
          <Code primary>TableFigure</Code>s also provide a scrollable overflow on mobile for tables with large amounts
          of data. Try removing the <Code primary>TableFigure</Code> component below in mobile view to see the
          differences.
        </Text>
        ...
        <H3>Usage with drag and drop</H3>

      ...
      default:
        return (
          <>
            ...
            <Panel header="With TableFigure">
              <Text>
                <Code primary>TableFigure</Code> components are used to wrap tables and any relevant information to be
                grouped with them.
                <Code primary>TableFigure</Code>s also provide a scrollable overflow on mobile for tables with large
                amounts of data. Try removing the <Code primary>TableFigure</Code> component below in mobile view to see
                the differences.
              </Text>
